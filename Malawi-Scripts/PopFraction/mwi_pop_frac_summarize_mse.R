...
ref.logis.uncrc$method <- 'LR-uncorrected'
...
ref.logis.crc$method <- 'LR-corrected'
...
ggplot(tau.method.frame, aes(x=logit(known_frac), y=tau, shape=method, color=method)) +
    scale_shape_manual(values=c(0,7,15,1,16,2,17))+
    geom_point(size=2.5)+#theme(axis.text.x = element_text(angle = 45,vjust = 0.5))+
  ...
  scale_colour_viridis_d()+
    theme (legend.position = 'bottom',legend.key.height=unit(0.5,'cm'),
           ...
           legend.key.width = unit(2,'cm'),legend.title = element_text(size=14),
...

{
  ...
  ggplot(compare.diff.tab, aes(x=matched_name, y=diff, shape=method, color=method)) +
    scale_shape_manual(values=c(0,7,15,1,16,2,17,18))+
    geom_point(size=2.5)+
...
pdf('natl_thresh_adm2_compare_err_facet.pdf', height = 12, 
    width =12)

{
  ...
  ggplot(compare.diff.tab, aes(x=matched_name, y=diff))+ #, shape=method, color=method)) +
    ...
    theme (legend.position = 'bottom',legend.key.height=unit(0.5,'cm'),
           ...
           legend.key.width = unit(2,'cm'),legend.title = element_text(size=12),
           strip.text.x = element_text(size = 12))+facet_wrap(~method,ncol = 2)
...

{
  ...
  ggplot(compare.diff.tab, aes(x=matched_name, y=abs_diff, shape=method, color=method)) +
    ...
    scale_shape_manual(values=c(0,7,15,1,16,2,17,18))+
    geom_point(size=2.5)+    xlab('Admin-2 region')+ylab('Absolute difference in urban fractions compared with census')+
    scale_colour_viridis_d()+
    theme (legend.position = 'bottom',legend.key.height=unit(0.5,'cm'),
           legend.text=element_text(size=14),
           axis.text.x = element_text(size = 15,angle = 45,vjust = 0.5),
           ...
           axis.title.y = element_text(size = 16),
           axis.text.y = element_text(size = 15),
           legend.key.width = unit(2,'cm'),legend.title = element_blank(),#legend.title = element_text(size=14),
           strip.text.x = element_text(size = 15))
...
pdf('natl_thresh_adm2_compare_abs_err_facet.pdf', height = 12, 
    width = 12)
